      ...
      <div className='container'>
        ...
        <div className='grid gap-14 lg:grid-cols-2 lg:items-center'>
          <div className='grid gap-7 lg:gap-10 '>
            {processData.list.map(({ icon, text, title }, index) => (
              <motion.div
                ...
                key={index}
              >
                <motion.div className='w-16 h-16 grid place-items-center rounded-full border border-foreground/5 shrink-0' variants={variants.fadeInScale}>
                  {icon}
                </motion.div>
          ...
          <div className='max-lg:-order-1 '>
            ...
            initial='start' whileInView='end' viewport={{once:true}} className='mx-auto bg-sidebar-primary rounded-3xl max-w-[580px] overflow-hidden p-8 !pb-0 lg:p-12 '>
              <img
                src={processBanner}
                alt='Process Banner'
                width={500}
