...
export function LoginForm({
  ...
  return (
    ...
    <form className={cn("flex flex-col gap-6","w-110 h-84", className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        {// Logo on the left }
        <div className="absolute top-11 left-23">
        <Link to="/">
          <Logo variant="icon" />
        </Link>
        </div>
...
import Logo from "@/components/Logo";
import { Link } from "react-router-dom";
import { setUser } from "@/redux/Store/userSlice"; // adjust this path based on your project structure
...
export function LoginForm({
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <form
        className={cn("flex flex-col gap-6", "w-110 h-84", className)}
