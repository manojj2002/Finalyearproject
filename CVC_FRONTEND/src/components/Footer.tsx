    ...
    <footer className="section !pb-0 ">
      <div className="container "> 
              ...
              <ul key={index}>
                ...
                {items.map(({href,label},index)=>(
                  <li key={index} className="text-muted-foreground">
                    <a href={href} className=" inline-block py-1  transition-colors hover:text-sidebar-primary">
                      {label}
                    </a>
                  </li>
                ))}
        ...
        <div className="flex justify-between mt-12  border-t border-gray-600/10  py-6 ">
          <a href="https://www.youtube.com/watch?v=DLPGApBMDWI"  target="_blank" className="">
