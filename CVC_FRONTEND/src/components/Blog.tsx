    ...
    <section className='section'>
      <div className='container'>
        ...
        <motion.div variants={variants.staggerContainer}
            initial='start'
            whileInView='end'
            viewport={{ once: true }} className='grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3'>
          {blogData.blogs.map(
            (
              {
                imgSrc,
                ...
                <Card className='group'>
                  ...
                  <CardContent>
                    ...
                    <CardTitle className='leading-normal '>
                      <a href='#' className='hover:text-sidebar-primary transition-colors'>{title}</a>
                    </CardTitle>
                  </CardContent>
