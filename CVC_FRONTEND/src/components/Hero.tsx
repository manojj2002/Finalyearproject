      ...
      >
        ...
        <div className='relative mt-12 max-w-screen-xl mx-auto isolate rounded-xl md:mt-16 '>
          ...
          <motion.div
            ...
            className='absolute bg-sidebar-primary inset-5 blur-[50px] -z-10'
          ></motion.div>
          <motion.div
            className='absolute inset-0 bg-sidebar-primary blur-[200px] scale-y-75 scale-x-125 rounded-full -z-10'
